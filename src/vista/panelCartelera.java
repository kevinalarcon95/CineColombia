...
public class panelCartelera extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        contenedorCartelera = new javax.swing.JPanel();
        ...
        btnComparBoleta0 = new javax.swing.JButton();
        ...
        jspPeliculas.setBorder(null);

        contenedorCartelera.setBackground(new java.awt.Color(255, 255, 255));
        contenedorCartelera.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lbl3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/mjercias13nov2019.png"))); // NOI18N
        ...
        contenedorCartelera.add(lbl3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 10, -1, -1));

        lbl2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/El hombre invisible.png"))); // NOI18N
        ...
        contenedorCartelera.add(lbl2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, -1, -1));

        lbl4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/parasito.png"))); // NOI18N
        ...
        contenedorCartelera.add(lbl4, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 10, -1, -1));

        lbl1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/angeldemivida-6-marzo-2020.jpg"))); // NOI18N
        ...
        contenedorCartelera.add(lbl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        lbl6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/1957.jpg"))); // NOI18N
        ...
        contenedorCartelera.add(lbl6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, -1, -1));

        lbl7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Los caballeros.jpg"))); // NOI18N
        ...
        contenedorCartelera.add(lbl7, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 220, -1, -1));

        lbl8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/la hora de la muerte.jpeg"))); // NOI18N
        ...
        contenedorCartelera.add(lbl8, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 220, -1, -1));

        lbl5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/El llamado salvaje.jpg"))); // NOI18N
        ...
        contenedorCartelera.add(lbl5, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 10, -1, -1));

        lbl10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/unidos.jpeg"))); // NOI18N
        ...
        contenedorCartelera.add(lbl10, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 220, -1, -1));

        lbl9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/sonic.jpeg"))); // NOI18N
        ...
        contenedorCartelera.add(lbl9, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 220, -1, -1));

        btnComparBoleta0.setBackground(new java.awt.Color(153, 153, 153));
        btnComparBoleta0.setFont(new java.awt.Font("Dialog", 1, 8)); // NOI18N
        btnComparBoleta0.setText("Comprar Boletas");
        btnComparBoleta0.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnComparBoleta0ActionPerformed(evt);
            }
        });
        contenedorCartelera.add(btnComparBoleta0, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 100, 20));

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 8)); // NOI18N
        jLabel1.setText("ANGEL DE MI VIDA");
        contenedorCartelera.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(8, 140, 100, 20));

        jLabel3.setFont(new java.awt.Font("Dialog", 1, 8)); // NOI18N
        jLabel3.setText("EL HOMBRE INVISIBLE");
        contenedorCartelera.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 140, 100, 20));
        ...
        contenedorCartelera.add(btnComparBoleta1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 160, 100, 20));

        jLabel4.setFont(new java.awt.Font("Dialog", 1, 8)); // NOI18N
        jLabel4.setText("MUJERCITAS");
        contenedorCartelera.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 140, 100, 20));
        ...
        contenedorCartelera.add(btnComparBoleta2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 160, 100, 20));
        ...
        contenedorCartelera.add(btnComparBoleta3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 160, 100, 20));

        jLabel5.setFont(new java.awt.Font("Dialog", 1, 8)); // NOI18N
        jLabel5.setText("PARÁSITO");
        contenedorCartelera.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 140, 100, 20));
        ...
        contenedorCartelera.add(btnComparBoleta4, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 160, 100, 20));

        jLabel6.setFont(new java.awt.Font("Dialog", 1, 8)); // NOI18N
        jLabel6.setText("EL LLAMADO SALVAJE");
        contenedorCartelera.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 140, 100, 20));

        jLabel7.setFont(new java.awt.Font("Dialog", 1, 8)); // NOI18N
        jLabel7.setText("1917");
        contenedorCartelera.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 350, 100, 20));
        ...
        contenedorCartelera.add(btnComparBoleta5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 100, 20));

        jLabel8.setFont(new java.awt.Font("Dialog", 1, 8)); // NOI18N
        jLabel8.setText("LOS CABALLEROS");
        contenedorCartelera.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 350, 100, 20));
        ...
        contenedorCartelera.add(btnComparBoleta6, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 370, 100, 20));
        ...
        contenedorCartelera.add(btnComparBoleta7, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 370, 100, 20));

        jLabel9.setFont(new java.awt.Font("Dialog", 1, 8)); // NOI18N
        jLabel9.setText("LA HORA DE TU MUERTE");
        contenedorCartelera.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 350, 100, 20));
        ...
        contenedorCartelera.add(btnComparBoleta8, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 370, 100, 20));

        jLabel21.setFont(new java.awt.Font("Dialog", 1, 8)); // NOI18N
        jLabel21.setText("SONIC LA PELÍCULA");
        contenedorCartelera.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 350, 100, 20));

        jLabel22.setFont(new java.awt.Font("Dialog", 1, 8)); // NOI18N
        jLabel22.setText("UNIDOS");
        contenedorCartelera.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 350, 100, 20));
        ...
        contenedorCartelera.add(btnComparBoleta9, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 370, 100, 20));
        ...
        contenedorBuscar.add(cbxPelicula, new org.netbeans.lib.awtextra.AbsoluteConstraints(255, 18, 213, 20));

        add(contenedorBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 480, -1));
    ...
    private javax.swing.JButton btnComparBoleta0;
    ...
    private javax.swing.JPanel contenedorCartelera;
